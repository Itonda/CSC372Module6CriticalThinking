...
public class StudentListInput {
    ...
    private void handleSortByRollNumber() {
        ...
        while (!validInput) {
            // Prompt the user to enter the sorting order (Asc/Desc) or R to return to menu
            ...
            switch (order) {
                case "A": // If the user enters A, sort by roll number in ascending order
                    displaySortByRollNumberAsc();
                    validInput = true;
                    break;
                case "D": // If the user enters D, sort by roll number in descending order
                    displaySortByRollNumberDesc();
                    validInput = true;
                    break;
                ...
                default: // If the user enters anything else, print a message indicating that the sorting order is invalid
                    System.out.println("\nERROR: Invalid sorting order. Please enter A or D.");
                    break;
            }
        }
    }
    ...
    private void handleSortByName() {
        ...
        while (!validInput) {
            ...
            // Switch case to handle the user's choice
            switch (order) {
                case "A": // If the user enters A, sort by name in ascending order
                    displaySortByNameAsc();
                    validInput = true;
                    break;
                case "D": // If the user enters D, sort by name in descending order
                    displaySortByNameDesc();
                    validInput = true;
                    break;
                case "R": // If the user enters R, return to menu
                    return; 
